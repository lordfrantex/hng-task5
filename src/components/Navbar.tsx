        ...
        <header className="bg-custom_offwhite">
            <div className="container max-w-[1440px] m-auto p-6">
                <div className="  m-auto flex justify-between px-6 py-4 bg-white  rounded-xl">
                    ...
                    <button className="px-[27px] py-[11px] bg-white border border-custom_blue rounded-lg font-semibold"><span className="sm:block hidden">Preview </span><span className="block sm:hidden "><EyeIcon height={20} width={20} /></span></button>
                </div>
            </div>
